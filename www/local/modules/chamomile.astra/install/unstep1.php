...
<form action="<?= $APPLICATION->GetCurPage() ?>">
    ...
    <input type="hidden" name="id" value="chamomile.astra">
    ...
    <!-- MOD_UNINST_WARN - системная языковая переменная -->
    ...
    <p><input type="checkbox" name="save_data" id="save_data" value="Y" checked><label
            for="save_data"><?= Loc::getMessage("MOD_UNINST_SAVE_TABLES") ?></label></p>
